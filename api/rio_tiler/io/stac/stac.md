...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/x.geotiff', 'application/x-hdf5', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff', 'image/tiff; application=geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/jp2', 'application/x-hdf'},
