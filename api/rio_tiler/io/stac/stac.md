...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/jp2', 'application/x-hdf5', 'image/x.geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/tiff', 'image/tiff; application=geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'application/x-hdf', 'image/tiff; profile=cloud-optimized; application=geotiff'},
