...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff; application=geotiff', 'application/x-hdf', 'image/x.geotiff', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/tiff', 'application/x-hdf5', 'image/jp2', 'image/tiff; application=geotiff; profile=cloud-optimized'},
