...
To learn more about efficiency of COG vs other file formats, check out [this blog post](https://medium.com/@_VincentS_/do-you-really-want-people-using-your-data-ec94cd94dc3f).
